...
(function(){
  ...
  function buildAI(){
    ...
    if(!document.querySelector('.ai-fab')){
      ...
      fab.innerHTML = '<svg class="spark" viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path d="M13 2L4.5 13.5H11l-1 8.5L18.5 10H12l1-8z" fill="#f5b820" stroke="#5a3d00" stroke-width="1.3" stroke-linejoin="round"/></svg><span>AI</span>';
